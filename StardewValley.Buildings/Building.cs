	...
	public class Building : INetObject<NetFields>
	{
		...
		public virtual void showDestroyedAnimation(GameLocation location)
		{
			for (int x = tileX; x < (int)tileX + (int)tilesWide; x++)
			{
				...
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(x * 64, y * 64) + new Vector2(Game1.random.Next(-16, 16), Game1.random.Next(-16, 16)), flicker: false, Game1.random.NextDouble() < 0.5)
					{
