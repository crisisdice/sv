	...
	public class FishingRod : Tool
	{
		...
		public override void resetState()
		{
			...
			if (lastUser != null && Game1.player == lastUser)
			{
				...
				{
					if (Game1.screenOverlayTempSprites[i].id == 987654340f)
					{
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (!bobber.Equals(Vector2.Zero) && isFishing)
			{
				...
				b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, bobberPos2), new Rectangle(179 + bobberBob * 9, 1903, 9, 9), Color.White, 0f, new Vector2(4f, 4f), scale, SpriteEffects.None, bobberLayerDepth);
			}
			...
			{
				Vector2 bobberPos = (isFishing ? ((Vector2)bobber) : ((animations.Count > 0) ? (animations[0].position + new Vector2(0f, 4f * scale)) : Vector2.Zero));
				if (whichFish != -1)
				{
				...
				Vector2 localBobber = Game1.GlobalToLocal(Game1.viewport, bobberPos + new Vector2(0f, -2f * scale + (float)((bobberBob == 1) ? 4 : 0)));
