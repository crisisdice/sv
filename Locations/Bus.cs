...
namespace StardewValley.Locations
{
  public class Bus : GameLocation
  {
    ...
    public override bool checkAction(Location tileLocation, xTile.Dimensions.Rectangle viewport, Farmer who)
    {
      ...
      switch (tile.TileIndex)
      {
        ...
        case 236:
          ...
          this.timesBagAttempt = this.timesBagAttempt + 1;
          break;
        case 238:
        ...
        case 225:
          if (!this.talkedToHaley)
            Game1.drawDialogue(Game1.getCharacterFromName("Haley", false), Game1.parseText(Game1.content.LoadString("Strings\\StringsFromCSFiles:Bus.cs.7152")));
          else
            Game1.drawDialogue(Game1.getCharacterFromName("Haley", false), Game1.parseText(Game1.content.LoadString("Strings\\StringsFromCSFiles:Bus.cs.7154")));
    ...
    {
      this.characters.Add(new NPC(new AnimatedSprite(Game1.content.Load<Texture2D>("Characters\\Dobson"), 0, Game1.tileSize, Game1.tileSize * 2), new Vector2((float) (-1000 * Game1.tileSize), (float) (3 * Game1.tileSize - Game1.tileSize)), nameof (Bus), 0, "Dobson", false, (Dictionary<int, int[]>) null, Game1.content.Load<Texture2D>("Portraits\\Dobson")));
