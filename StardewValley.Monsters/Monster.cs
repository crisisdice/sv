	...
	public class Monster : NPC
	{
		...
		public override void MovePosition(GameTime time, xTile.Dimensions.Rectangle viewport, GameLocation currentLocation)
		{
			...
			if (moveUp)
			{
				...
				{
					Microsoft.Xna.Framework.Rectangle tmp4 = this.nextPosition(0);
					tmp4.Width /= 4;
					bool leftCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
					tmp4.X += tmp4.Width * 3;
					bool rightCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
			...
			else if (moveRight)
			{
				...
				else
				{
					...
					tmp3.Height /= 4;
					bool topCorner2 = currentLocation.isCollidingPosition(tmp3, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
					tmp3.Y += tmp3.Height * 3;
					bool bottomCorner2 = currentLocation.isCollidingPosition(tmp3, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
			...
			else if (moveDown)
			{
				...
				else
				{
					...
					tmp2.Width /= 4;
					bool leftCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
					tmp2.X += tmp2.Width * 3;
					bool rightCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
