	...
	public class FruitTree : TerrainFeature
	{
		...
		public override void draw(SpriteBatch spriteBatch, Vector2 tileLocation)
		{
			...
			if ((int)growthStage < 4)
			{
				...
				sourceRect = growthStage switch
				{
					0L => new Rectangle(0, (int)treeType * 5 * 16, 48, 80), 
					1L => new Rectangle(48, (int)treeType * 5 * 16, 48, 80), 
					2L => new Rectangle(96, (int)treeType * 5 * 16, 48, 80), 
