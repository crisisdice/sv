...
namespace StardewValley
{
	internal class ReadyCheck : INetObject<NetFields>
	{
		...
		public void Update()
		{
			if (readyPlayers.Contains(Game1.player) && !setPlayers.Contains(Game1.player) && !(Game1.activeClickableMenu is SaveGameMenu) && !(Game1.activeClickableMenu is ShippingMenu) && (!(Game1.activeClickableMenu is ReadyCheckDialog dialog) || dialog.checkName != Name))
			{
