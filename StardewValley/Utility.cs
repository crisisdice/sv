...
namespace StardewValley
{
	public class Utility
	{
		...
		private static Dictionary<ISalable, int[]> generateLocalTravelingMerchantStock(int seed)
		{
			...
			{
				addToStock(stock, stockIndices, new Object(Vector2.Zero, 136), new int[2] { 4000, 1 });
			}
			if (r.NextDouble() < 0.25)
			{
				addToStock(stock, stockIndices, new Object(433, 1), new int[2] { 2500, 1 });
			}
			return stock;
		}
		...
		public static int getRandomItemFromSeason(string season, int randomSeedAddition, bool forQuest, bool changeDaily = true)
		{
			...
			if (forQuest)
			{
				foreach (string s in all_unlocked_cooking_recipes)
				{
					...
					List<int> cropsAvailableNow = possibleCropsAtThisTime(Game1.currentSeason, Game1.dayOfMonth <= 7);
