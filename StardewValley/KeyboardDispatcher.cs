...
namespace StardewValley
{
	public class KeyboardDispatcher
	{
		...
		public void Poll()
		{
			...
			modifier_held = ((!RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) ? (keyboard_state.IsKeyDown(Keys.LeftControl) || keyboard_state.IsKeyDown(Keys.RightControl)) : (keyboard_state.IsKeyDown(Keys.LeftWindows) || keyboard_state.IsKeyDown(Keys.RightWindows)));
