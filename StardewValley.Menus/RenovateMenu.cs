			...
			if (_buildAnimationCount > 0)
			{
				...
				if (_renovation.animationType == HouseRenovation.AnimationType.Destroy)
				{
					...
					for (int j = 0; j < 5; j++)
					{
						...
						_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(x2, y2), flicker: false, Game1.random.NextDouble() < 0.5));
						_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(x2, y2), flicker: false, Game1.random.NextDouble() < 0.5));
				...
				else
				{
					...
					for (int i = 0; i < 20; i++)
					{
						...
						_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90) - 64, 6, 1, new Vector2(x, y), flicker: false, Game1.random.NextDouble() < 0.5));
						_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90) - 64, 6, 1, new Vector2(x, y), flicker: false, Game1.random.NextDouble() < 0.5));
					}
				}
			}
