...
namespace StardewValley.Menus
{
	public class MapPage : IClickableMenu
	{
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			foreach (ClickableComponent c in points)
			{
				if (c.containsPoint(x, y) && c.name == "Lonely Stone")
				{
		...
		public override void draw(SpriteBatch b)
		{
			...
			case 7:
				...
				{
					Texture2D map_texture = Game1.content.Load<Texture2D>(Game1.whichModFarm.WorldMapTexture);
					b.Draw(map_texture, new Vector2(mapX, mY + 172), null, Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.861f);
				}
				else
				{
					b.Draw(map, new Vector2(mapX, mY + 172), new Rectangle(0, 180, 131, 61), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.861f);
