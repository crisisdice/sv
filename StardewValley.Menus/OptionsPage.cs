...
namespace StardewValley.Menus
{
	public class OptionsPage : IClickableMenu
	{
			...
			: base(x, y, width, height)
		{
			...
			options.Add(new OptionsCheckbox("Always show energy bar", 44));
			...
			if (Game1.game1.IsMainInstance)
			{
				options.Add(new OptionsPlusMinus(Game1.content.LoadString("Strings\\StringsFromCSFiles:OptionsPage.cs.11267"), 25, new List<string> { "Low", "Med.", "High" }, new List<string>
				{
		...
		public override void snapCursorToCurrentSnappedComponent()
		{
			...
			{
				if (options[currentlySnappedComponent.myID + currentItemIndex] is OptionsDropDown dropdown)
				{
