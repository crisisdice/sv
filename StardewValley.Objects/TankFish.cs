...
namespace StardewValley.Objects
{
	public class TankFish
	{
		...
		public TankFish(FishTankFurniture tank, Item item)
		{
			...
			{
				string obj = aquarium_fish_split[3];
				string[] animation_split3 = obj.Split(' ');
			...
			{
				string obj2 = aquarium_fish_split[4];
				string[] animation_split2 = obj2.Split(' ');
			...
			{
				string obj3 = aquarium_fish_split[5];
				string[] animation_split = obj3.Split(' ');
