	...
	public class FishingQuest : Quest
	{
		...
		public void loadQuestInfo()
		{
			...
			if (random.NextDouble() < 0.5)
			{
				...
				case "summer":
				{
					int[] possiblefish2 = new int[10] { 130, 131, 136, 138, 142, 144, 145, 146, 149, 150 };
					whichFish.Value = possiblefish2[random.Next(possiblefish2.Length)];
					break;
				}
				case "fall":
				{
					int[] possiblefish2 = new int[8] { 129, 131, 136, 137, 139, 142, 143, 150 };
					whichFish.Value = possiblefish2[random.Next(possiblefish2.Length)];
					break;
				}
				case "winter":
				{
					int[] possiblefish2 = new int[9] { 130, 131, 136, 141, 144, 146, 147, 150, 151 };
					whichFish.Value = possiblefish2[random.Next(possiblefish2.Length)];
					break;
				}
				}
			...
			else
			{
				...
				case "spring":
				{
					int[] possiblefish = new int[9] { 129, 131, 136, 137, 142, 143, 145, 147, 702 };
