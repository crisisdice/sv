...
namespace StardewValley.Locations
{
	public class IslandWest : IslandLocation
	{
		...
		public override void spawnObjects()
		{
			...
			if (Utility.getNumObjectsOfIndexWithinRectangle(musselNodeSpawnArea, new int[1] { 25 }, this) < 10)
			{
			...
			if (Utility.getNumObjectsOfIndexWithinRectangle(tidePoolsArea, new int[2] { 393, 397 }, this) < 5)
			{
