...
namespace StardewValley.Locations
{
	public class IslandNorth : IslandLocation
	{
		...
		public static Dictionary<ISalable, int[]> getIslandMerchantTradeStock(Farmer who)
		{
			...
			tradeStock.Add(i, new int[4] { 0, 2147483647, 830, 5 });
			i = new Object(831, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 881, 2 });
			i = new Object(833, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 851, 1 });
			if (Game1.netWorldState.Value.GoldenCoconutCracked.Value)
			{
				i = new Object(791, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 88, 10 });
			}
			i = new TV(2326, Vector2.Zero);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 830, 30 });
			i = new Furniture(2331, Vector2.Zero);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 848, 5 });
			if (Game1.dayOfMonth % 2 == 0)
			{
				i = new Furniture(134, Vector2.Zero);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 837, 1 });
			}
			i = new Object(69, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 852, 5 });
			i = new Object(835, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 719, 75 });
		...
		public void digSiteUpdate()
		{
			...
			if (Utility.getNumObjectsOfIndexWithinRectangle(digSiteBounds, new int[9] { 816, 817, 818, 819, 32, 38, 40, 42, 590 }, this) < 60)
			{
			...
			{
				if (Utility.getNumObjectsOfIndexWithinRectangle(digSiteBounds, new int[3] { 785, 676, 677 }, this) >= 100)
				{
					return;
				}
				int times = r.Next(4);
