	...
	public class MovieTheater : GameLocation
	{
		...
		private void addSpecificRandomNPC(int whichRandomNPC)
		{
			...
			case 1:
				...
				break;
			case 2:
				setAnimatedMapTile(21, 7, new int[4] { 217, 217, 217, 218 }, 700L, "Buildings", "MessageSpeech MovieTheater_ShortsMan" + ((r.NextDouble() < 0.5) ? "2" : ""));
			...
			case 4:
				...
				break;
			case 5:
				setAnimatedMapTile(10, 7, new int[4] { 251, 251, 251, 252 }, 900L, "Buildings", "MessageSpeech MovieTheater_Lupini" + ((r.NextDouble() < 0.5) ? "2" : ""));
				setAnimatedMapTile(10, 6, new int[4] { 235, 235, 235, 236 }, 900L, "Front", null);
				break;
			case 6:
				setAnimatedMapTile(5, 7, new int[4] { 249, 249, 249, 250 }, 600L, "Buildings", "MessageSpeech MovieTheater_ConcessionMan" + ((r.NextDouble() < 0.5) ? "2" : ""));
