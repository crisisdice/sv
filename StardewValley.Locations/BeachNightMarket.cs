...
namespace StardewValley.Locations
{
	public class BeachNightMarket : GameLocation
	{
		...
		public Dictionary<ISalable, int[]> getBlueBoatStock()
		{
			...
			stock.Add(new Object(Vector2.Zero, 40), new int[2] { 200, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 41), new int[2] { 200, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 42), new int[2] { 200, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 43), new int[2] { 200, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 44), new int[2] { 200, 2147483647 });
			stock.Add(new Furniture(2397, Vector2.Zero), new int[2] { 800, 2147483647 });
			stock.Add(new Furniture(2398, Vector2.Zero), new int[2] { 800, 2147483647 });
			stock.Add(new Furniture(1975, Vector2.Zero), new int[2] { 1000, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 48), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 184), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 188), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 192), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 196), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 200), new int[2] { 500, 2147483647 });
			stock.Add(new Object(Vector2.Zero, 204), new int[2] { 500, 2147483647 });
			return stock;
		}
		...
		public Dictionary<ISalable, int[]> geMagicShopStock()
		{
			...
			{
			case 1:
				stock.Add(new Object(Vector2.Zero, 47), new int[2] { 200, 2147483647 });
				stock.Add(new Object(Vector2.Zero, 52), new int[2] { 500, 2147483647 });
				stock.Add(new Hat(39), new int[2] { 5000, 2147483647 });
				...
				stock.Add(new Furniture(1796, Vector2.Zero), new int[2] { 15000, 2147483647 });
				break;
			case 2:
				stock.Add(new Object(Vector2.Zero, 33), new int[2] { 200, 2147483647 });
				stock.Add(new Object(Vector2.Zero, 53), new int[2] { 500, 2147483647 });
				stock.Add(new Hat(39), new int[2] { 2500, 2147483647 });
				...
				break;
			case 3:
				stock.Add(new Object(Vector2.Zero, 46), new int[2] { 200, 2147483647 });
				stock.Add(new Object(Vector2.Zero, 54), new int[2] { 500, 2147483647 });
				stock.Add(new Hat(39), new int[2] { 10000, 2147483647 });
				stock.Add(new Object(487, 1), new int[2]
				{
					(int)((float)(Convert.ToInt32(Game1.objectInformation[487].Split('/')[1]) * 2) * Game1.MasterPlayer.difficultyModifier),
					2147483647
			...
			{
				stock.Add(new Object(Vector2.Zero, 139), new int[2] { 5000, 2147483647 });
			}
			if (donated_minerals + donated_artifacts >= 40)
			{
				stock.Add(new Object(Vector2.Zero, 140), new int[2] { 5000, 2147483647 });
			}
			return stock;
		}
	}
