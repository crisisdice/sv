...
namespace StardewValley.Locations
{
	public class Desert : GameLocation
	{
		...
		public static Dictionary<ISalable, int[]> getDesertMerchantTradeStock(Farmer who)
		{
			...
			tradeStock.Add(i, new int[4] { 0, 2147483647, 749, 5 });
			i = new Object(261, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 749, 3 });
			i = new Object(253, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 72, 1 });
			i = new Object(226, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 64, 1 });
			i = new Object(288, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 386, 5 });
			i = new Object(287, 1);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 80, 5 });
			if (Game1.dayOfMonth % 7 == 0)
			{
				i = new Object(Vector2.Zero, 71);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 70, 1 });
			}
			if (Game1.dayOfMonth % 7 == 1)
			{
				i = new Object(178, 3);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 749, 1 });
			}
			if (Game1.dayOfMonth % 7 == 2)
			{
				i = new Object(771, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 390, 5 });
			}
			if (Game1.dayOfMonth % 7 == 3)
			{
				i = new Object(428, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 62, 3 });
			}
			if (Game1.dayOfMonth % 7 == 4 && !boughtMagicRockCandy)
			{
				i = new Object(279, 1);
				tradeStock.Add(i, new int[4] { 0, 1, 74, 3 });
			}
			if (Game1.dayOfMonth % 7 == 5)
			{
				i = new Object(424, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 60, 1 });
			}
			if (Game1.dayOfMonth % 7 == 6)
			{
				i = new Object(495, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 496, 2 });
				i = new Object(496, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 497, 2 });
				i = new Object(497, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 498, 2 });
				i = new Object(498, 1);
				tradeStock.Add(i, new int[4] { 0, 2147483647, 495, 2 });
			}
			if (who != null && !who.craftingRecipes.ContainsKey("Warp Totem: Desert"))
			{
				i = new Object(261, 1, isRecipe: true);
				tradeStock.Add(i, new int[4] { 0, 1, 337, 10 });
			}
			...
			{
				i = new Object(808, 1);
				tradeStock.Add(i, new int[4] { 0, 1, 769, 200 });
			}
			i = new Furniture(1971, Vector2.Zero);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 767, 200 });
			i = new Hat(72);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 749, 50 });
			i = new Hat(73);
			if (Game1.stats.DaysPlayed % 2u == 0)
			{
				i = new Hat(74);
			}
			tradeStock.Add(i, new int[4] { 0, 2147483647, 749, 333 });
			i = new BedFurniture(2508, Vector2.Zero);
			tradeStock.Add(i, new int[4] { 0, 2147483647, 797, 1 });
			return tradeStock;
		}
		...
		{
			if (lastQuestionKey != null && afterQuestion == null && lastQuestionKey.Split(' ')[0] + "_" + answer.responseKey == "DesertBus_Yes")
			{
