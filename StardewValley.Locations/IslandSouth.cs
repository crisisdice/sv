...
namespace StardewValley.Locations
{
	public class IslandSouth : IslandLocation
	{
		...
		public static void SetupIslandSchedules()
		{
			...
			if (Utility.isFestivalDay(Game1.Date.DayOfMonth, Game1.Date.Season) || (Game1.Date.Season == "winter" && Game1.Date.DayOfMonth >= 15 && Game1.Date.DayOfMonth <= 17) || !(Game1.getLocationFromName("IslandSouth") is IslandSouth island) || !island.resortRestored.Value || Game1.IsRainingHere(island) || !island.resortOpenToday.Value)
			{
				return;
			}
